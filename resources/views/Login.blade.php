      ...
      <div class="col-sm-4">
        <div class="signup-form"><!--sign up form-->
          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            {{ Form::checkbox('pharmacist', true, true) }}Pharmacist
            {{ Form::checkbox('user', true, true) }}User
{{--            <div>--}}
{{--              <input id="pharmacist" type="checkbox" class="form-control" name="Roles"--}}
{{--                     value={{false}}>Pharmacist--}}
{{--            </div>--}}

{{--            <div>--}}
{{--              <input id="user" type="checkbox" class="form-control" name="Roles"--}}
{{--                     value={{false}}>User--}}
{{--            </div>--}}
